        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            ...
            <div className={isSubMenuOpen ? 'sub-menu-wrap open-menu' : 'sub-menu-wrap'} id="subMenu">
              <div class="sub-menu">
                <a href="/swagger/carmanagement" class="sub-menu-link">
                  <img src=""></img>
                  <h5>carmanagement</h5>
                  <span>&gt;</span>
                </a>
                ...
                <hr></hr>
                <span></span>
                <a href="/swagger/reservationmanagement" class="sub-menu-link">
                  <img src=""></img>
                  <h5>reservationmanagement</h5>
                  <span>&gt;</span>
                </a>
              </div>
            </div>
            ...
            <div className={isSubMenuOpenForNotes ? 'sub-menu-wrap open-menu' : 'sub-menu-wrap'} id="subMenu">
              <div class="sub-menu">
                <a href="/notes/carmanagement" class="sub-menu-link">
                  <img src=""></img>
                  <h5>carmanagement</h5>
                  <span>&gt;</span>
                </a>
                ...
                <hr></hr>
                <span></span>
                <a href="/notes/reservationmanagement" class="sub-menu-link">
                  <img src=""></img>
                  <h5>reservationmanagement</h5>
                  <span>&gt;</span>
                </a>
