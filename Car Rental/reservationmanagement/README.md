# reservationmanagement prototype
...
On launch, reservationmanagement will refuse to start if it is not able to connect to any of the above component(s).
...
Open [http://localhost:4003/hello](http://localhost:4003/hello) to view it in your browser.

The page will reload when you make changes.

## Containerization

Build the docker image: `docker build -t reservationmanagement:latest .`

Start the container: `docker run -d -p 4003:4003 reservationmanagement:latest`
