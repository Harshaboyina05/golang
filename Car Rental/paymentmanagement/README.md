...
Open [http://localhost:4002/hello](http://localhost:4002/hello) to view it in your browser.
...
Start the container: `docker run -d -p 4002:4002 paymentmanagement:latest`
